        ...
        <li key={w.id}>
          <Collapsible open={openId === w.id}>
            <CollapsibleTrigger asChild>
              <button
                className="w-full text-left py-3 px-2 flex flex-col items-start active:bg-muted/50 transition rounded group"
              ...
              >
                ...
                {w.examples.length > 0 && (
                  <span className="text-xs text-blue-700 mt-1 opacity-70 group-hover:underline">
            ...
            <CollapsibleContent>
              {w.examples.length > 0 && (
                <ul className="text-sm text-muted-foreground pl-5 pb-3">
                  {w.examples.map((ex, idx) => (
                    <li key={idx} className="list-disc">{ex}</li>
                  ))}
                </ul>
              )}
            </CollapsibleContent>
