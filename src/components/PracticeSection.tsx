...
export default function PracticeSection({
  ...
  return <div className="flex flex-col items-center justify-center py-8 w-full max-w-lg mx-auto">
      <div className="bg-card rounded-xl shadow p-6 w-full">
        ...
        <form onSubmit={handleCheckAnswer} className="flex flex-col gap-4 items-center">
          ...
          <input className="w-full border rounded-lg px-3 py-2 text-base focus:outline-primary" type="text" placeholder="Your answer..." autoFocus value={input} onChange={e => setInput(e.target.value)} disabled={state !== "idle"} />
